    ...
    .action(async ({
        ...
        if (!isAuth) redirect('/login')
            ...
            if(ticket.id === '(New)') {
               ...
               return { message: `Ticket ID #${result[0].insertedId} created successfuly`}
            }
            ...
            .returning({ updateId: tickets.id})

        return { message: `Ticket ID #${result[0].updateId} updated sucessfuly`}
    })
